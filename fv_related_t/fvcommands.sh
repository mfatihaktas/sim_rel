...
then
	...
	fvctl -f fvpasswd_file add-slice --password=1 sch_cntslice tcp:192.168.56.1:9010 mfa
...
then
	...
	fvctl -f fvpasswd_file remove-slice sch_cntslice
...
then
	...
	fvctl -f fvpasswd_file add-flowspace cnt1flowspace all 10 tp_dst=6000 cnt1slice=7 #,myslice2=0
	fvctl -f fvpasswd_file add-flowspace sch_cntflowspace all 10 tp_dst=7000 sch_cntslice=7 #,myslice2=0
	fvctl -f fvpasswd_file add-flowspace arpflowspace all 10 dl_type=0x806 arpslice=7 #,myslice2=0
else
