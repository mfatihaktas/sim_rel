...
if [ $1  = 'p' ]; then
  ...
  python producer.py --intf=p-eth0 --dtst_port=7000 --dtsl_ip=10.0.0.255 --dtsl_port=7000 --cl_ip=10.0.0.1 \
                     --proto=udp --tx_type=file --file_url=ltx.dat --logto=file \
  ...
  python consumer.py --intf=c-eth0 --cl_port_list=6000,6001,6002 --dtst_pnofBs_sentort=7000 --dtsl_ip=10.0.0.255 --dtsl_port=7000 \
  ...
  #python sender.py --dst_ip=127.0.0.1 --dst_lport=7001 --datasize=1 --proto=udp --tx_type=dummy --file_url=ltx.dat
  python sender.py --dst_ip=127.0.0.1 --dst_lport=6000 --datasize=20 --proto=tcp --tx_type=dummy --file_url=ltx.dat
elif [ $1  = 'r' ]; then
  #python receiver.py --lintf=t11-eth0 --lport=6000 --proto=tcp --rx_type=dummy --file_url=rx.dat
  python receiver.py --lintf=lo --lport=6000 --proto=tcp --rx_type=dummy --file_url=rx.dat
elif [ $1  = 'sp' ]; then
  python sender.py --dst_ip=10.0.0.1 --dst_lport=6000 --datasize=100 --proto=tcp --tx_type=dummy --file_url=ltx.dat
elif [ $1  = 'rc' ]; then
  python receiver.py --lintf=c-eth0 --lport=6000 --proto=tcp --rx_type=dummy --file_url=rx.dat
elif [ $1  = 'glf' ]; then
