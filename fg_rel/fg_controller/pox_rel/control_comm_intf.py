...
class ThreadedTCPRequestHandler(SocketServer.BaseRequestHandler):
  def handle(self):
    ...
    logging.info('cur_thread=%s; response=%s is sent back to client.', cur_thread.name, response)
################################################################################
sctag_msgtypes_dict = {'scher-acter':{'send_type':['sp_sching_dec'],
                                      'recv_type':['sp_sching_reply'] },
                       'acter-scher':{'send_type':['sp_sching_reply'],
                                      'recv_type':['sp_sching_dec'] },
                       'dts-user':{'send_type':['join_reply', 'sching_reply'],
                                   'recv_type':['join_req', 'sching_req'] },
                       'user-dts':{'send_type':['join_req', 'sching_req'],
