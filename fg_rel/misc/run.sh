...
VMSNAP_PIVIPS=( 10.39.1.70 10.39.1.71 10.39.1.72 )
...
#####################################################  
  ...
  #sftp -v -o "IdentityFile=$KEYDIR" ${VMSNAP_NAMES[$2]}@${VMSNAP_PIVIPS[$2]}:~/
  cat ~/misc/net_2p_stwithsingleitr.py | ssh -l ${VMSNAP_USRNAMES[$2]} -i $KEYDIR ${VMSNAP_PIVIPS[$2]} 'cat >> ~/net.py'
else
